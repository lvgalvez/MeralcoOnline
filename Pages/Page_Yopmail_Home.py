...
class YopmailHomePage:
    ...
    def get_check_inbox(self, driver):
        return WebDriverWait(driver, 20).until(EC.visibility_of_element_located((By.XPATH, self.check_inbox)))

    def get_here_link(self, driver):
        return driver.find_element(By.XPATH, self.here_link)

    #def get_here_link(self, driver):
    #    return WebDriverWait(driver, 40).until(EC.visibility_of_element_located((By.XPATH, self.here_link)))
