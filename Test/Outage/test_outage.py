...
class TestOutage:
    ...
    @pytest.mark.tags("TS033", "Overnight")
    def test_ts033(self):
        test_scenario = "TS033"
        Functions().create_document(self.driver, self.module, test_scenario)
    ...
    @pytest.mark.tags("TS050", "Overnight")
    def test_ts050(self):
        test_scenario = "TS050"
        Functions().create_document(self.driver, self.module, test_scenario)
    ...
    @pytest.mark.tags("TS051", "Overnight")
    def test_ts051(self):
        test_scenario = "TS051"
        Functions().create_document(self.driver, self.module, test_scenario)
    ...
    @pytest.mark.tags("TS052", "Overnight")
    def test_ts052(self):
        test_scenario = "TS052"
        Functions().create_document(self.driver, self.module, test_scenario)
    ...
    @pytest.mark.tags("TS053", "Overnight")
    def test_ts053(self):
        test_scenario = "TS053"
        Functions().create_document(self.driver, self.module, test_scenario)
    ...
    @pytest.mark.tags("TS054", "Overnight")
    def test_ts054(self):
        test_scenario = "TS054"
        Functions().create_document(self.driver, self.module, test_scenario)
    ...
    @pytest.mark.tags("TS055", "Overnight")
    def test_ts055(self):
        test_scenario = "TS055"
        Functions().create_document(self.driver, self.module, test_scenario)
    ...
    @pytest.mark.tags("TS056", "Overnight")
    def test_ts056(self):
        test_scenario = "TS056"
        Functions().create_document(self.driver, self.module, test_scenario)
    ...
    @pytest.mark.tags("TS057", "Overnight")
    def test_ts057(self):
        test_scenario = "TS057"
        Functions().create_document(self.driver, self.module, test_scenario)
    ...
    @pytest.mark.tags("TS058", "Overnight")
    def test_ts058(self):
        test_scenario = "TS058"
        Functions().create_document(self.driver, self.module, test_scenario)
    ...
    @pytest.mark.tags("TS059", "Overnight")
    def test_ts059(self):
        test_scenario = "TS059"
        Functions().create_document(self.driver, self.module, test_scenario)
    ...
    @pytest.mark.tags("TS060", "Overnight")
    def test_ts060(self):
        test_scenario = "TS060"
        Functions().create_document(self.driver, self.module, test_scenario)
    ...
    @pytest.mark.tags("TS061", "Overnight")
    def test_ts061(self):
        test_scenario = "TS061"
        Functions().create_document(self.driver, self.module, test_scenario)
    ...
    @pytest.mark.tags("TS062", "Overnight")
    def test_ts062(self):
        test_scenario = "TS062"
        Functions().create_document(self.driver, self.module, test_scenario)
    ...
    @pytest.mark.tags("TS063", "Overnight")
    def test_ts063(self):
        test_scenario = "TS063"
        Functions().create_document(self.driver, self.module, test_scenario)
    ...
    @pytest.mark.tags("TS064", "Overnight")
    def test_ts064(self):
        test_scenario = "TS064"
        Functions().create_document(self.driver, self.module, test_scenario)
    ...
    @pytest.mark.tags("TS066", "Overnight")
    def test_ts066(self):
        test_scenario = "TS066"
        Functions().create_document(self.driver, self.module, test_scenario)
    ...
    @pytest.mark.tags("TS067", "Overnight")
    def test_ts067(self):
        test_scenario = "TS067"
        Functions().create_document(self.driver, self.module, test_scenario)
    ...
    @pytest.mark.tags("TS068", "Overnight")
    def test_ts068(self):
        test_scenario = "TS068"
        Functions().create_document(self.driver, self.module, test_scenario)
    ...
    @pytest.mark.tags("TS069", "Overnight")
    def test_ts069(self):
        test_scenario = "TS069"
        Functions().create_document(self.driver, self.module, test_scenario)
    ...
    @pytest.mark.tags("TS070", "Overnight")
    def test_ts070(self):
        test_scenario = "TS070"
        Functions().create_document(self.driver, self.module, test_scenario)
    ...
    @pytest.mark.tags("TS071", "Overnight")
    def test_ts071(self):
        test_scenario = "TS071"
        Functions().create_document(self.driver, self.module, test_scenario)
    ...
    @pytest.mark.tags("TS072", "Overnight")
    def test_ts072(self):
        test_scenario = "TS072"
        Functions().create_document(self.driver, self.module, test_scenario)
