...
class TestOutage:
    ...
    def test_ts021(self):
        ...
        TC058(self.driver, test_scenario, Outage['first_name'], Outage['middle_name'],
              Outage['last_name'], Outage['mobile_number'], Outage['landline'], Outage['email'], Outage['pole_number'])
        Functions().tag_status(self.module, test_scenario, "Passed")
    ...
    @pytest.mark.tags("TS023", "Overnight")
    def test_ts023(self):
        test_scenario = "TS023"
        Functions().create_document(self.driver, self.module, test_scenario)
    ...
    @pytest.mark.tags("TS024", "Overnight")
    def test_ts024(self):
        test_scenario = "TS024"
        Functions().create_document(self.driver, self.module, test_scenario)
    ...
    @pytest.mark.tags("TS025", "Overnight")
    def test_ts025(self):
        test_scenario = "TS025"
        Functions().create_document(self.driver, self.module, test_scenario)
        TC060(self.driver, test_scenario, Outage['cxe_email'], Outage['cxe_password'], "wind_speed", 13)
        Functions().tag_status(self.module, test_scenario, "Passed")

    @pytest.mark.tags("TS026", "Overnight")
    def test_ts026(self):
        test_scenario = "TS026"
        Functions().create_document(self.driver, self.module, test_scenario)
    ...
    @pytest.mark.tags("TS035", "Overnight")
    def test_ts035(self):
        test_scenario = "TS035"
        Functions().create_document(self.driver, self.module, test_scenario)
        ...
        TC064(self.driver, test_scenario, Outage['cxe_email'], Outage['cxe_password'])
        TC065(self.driver, test_scenario)
        Functions().tag_status(self.module, test_scenario, "Passed")

    @pytest.mark.tags("TS036", "Overnight")
    def test_ts036(self):
        test_scenario = "TS036"
        Functions().create_document(self.driver, self.module, test_scenario)
        ...
        TC070(self.driver, test_scenario) #VALIDATED
        TC072(self.driver, test_scenario)
        Functions().tag_status(self.module, test_scenario, "Passed")

    @pytest.mark.tags("TS037", "Overnight")
    def test_ts037(self):
        test_scenario = "TS037"
        Functions().create_document(self.driver, self.module, test_scenario)
        TC074(self.driver, test_scenario, Outage['cxe_email'], Outage['cxe_password'])
        Functions().tag_status(self.module, test_scenario, "Passed")

    @pytest.mark.tags("TS038", "Overnight")
    def test_ts038(self):
        test_scenario = "TS038"
        Functions().create_document(self.driver, self.module, test_scenario)
    ...
    @pytest.mark.tags("TS039", "Overnight")
    def test_ts039(self):
        test_scenario = "TS039"
        Functions().create_document(self.driver, self.module, test_scenario)
        TC079(self.driver, test_scenario, Outage['cxe_email'], Outage['cxe_password'])
    ...
    @pytest.mark.tags("TS040", "Overnight")
    def test_ts040(self):
        test_scenario = "TS040"
        Functions().create_document(self.driver, self.module, test_scenario)
    ...
    @pytest.mark.tags("TS041", "Overnight")
    def test_ts041(self):
        test_scenario = "TS041"
        Functions().create_document(self.driver, self.module, test_scenario)
        TC088(self.driver, test_scenario, Outage['cxe_email'], Outage['cxe_password'])
        TC089(self.driver, test_scenario)
        TC090(self.driver, test_scenario)
        TC091(self.driver, test_scenario)
        TC093(self.driver, test_scenario)
        TC094(self.driver, test_scenario)
        TC095(self.driver, test_scenario)
        TC096(self.driver, test_scenario)
        TC097(self.driver, test_scenario)
        TC098(self.driver, test_scenario)
        TC099(self.driver, test_scenario)
        TC100(self.driver, test_scenario)
        Functions().tag_status(self.module, test_scenario, "Passed")

    @pytest.mark.tags("TS042", "Overnight")
    def test_ts042(self):
        test_scenario = "TS042"
        Functions().create_document(self.driver, self.module, test_scenario)
    ...
    @pytest.mark.tags("TS043", "Overnight")
    def test_ts043(self):
        test_scenario = "TS043"
        Functions().create_document(self.driver, self.module, test_scenario)
        TC108(self.driver, test_scenario, Outage['cxe_email'], Outage['cxe_password'])
        TC109(self.driver, test_scenario)
        TC110(self.driver, test_scenario)
        TC111(self.driver, test_scenario)
        Functions().tag_status(self.module, test_scenario, "Passed")

    @pytest.mark.tags("TS044", "Overnight")
    def test_ts044(self):
        test_scenario = "TS044"
        Functions().create_document(self.driver, self.module, test_scenario)
        TC112(self.driver, test_scenario, Outage['cxe_email'], Outage['cxe_password'])
        TC113(self.driver, test_scenario)
        TC114(self.driver, test_scenario)
        Functions().tag_status(self.module, test_scenario, "Passed")

    @pytest.mark.tags("TS045", "Overnight")
    def test_ts045(self):
        test_scenario = "TS045"
        Functions().create_document(self.driver, self.module, test_scenario)
        ...
        TC120(self.driver, test_scenario)
        TC121(self.driver, test_scenario)

        Functions().tag_status(self.module, test_scenario, "Passed")

    @pytest.mark.tags("TS046", "Overnight")
    def test_ts046(self):
        test_scenario = "TS046"
        Functions().create_document(self.driver, self.module, test_scenario)
        TC069(self.driver, test_scenario)
        Functions().tag_status(self.module, test_scenario, "Passed")

    @pytest.mark.tags("TS047", "Overnight")
    def test_ts047(self):
        test_scenario = "TS047"
        Functions().create_document(self.driver, self.module, test_scenario)
    ...
    @pytest.mark.tags("TS048", "Overnight")
    def test_ts048(self):
        test_scenario = "TS048"
        Functions().create_document(self.driver, self.module, test_scenario)
    ...
    @pytest.mark.tags("TS049", "Overnight")
    def test_ts049(self):
        test_scenario = "TS049"
        Functions().create_document(self.driver, self.module, test_scenario)
    ...
    def test_ts065(self):
        test_scenario = "TS065"
        Functions().create_document(self.driver, self.module, test_scenario)
        TC150(self.driver, test_scenario, Outage['outage_email'], Outage['outage_password'])
        Functions().tag_status(self.module, test_scenario, "Passed")
